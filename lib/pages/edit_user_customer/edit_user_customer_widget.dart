...
import 'edit_user_customer_model.dart';
export 'edit_user_customer_model.dart';

class EditUserCustomerWidget extends StatefulWidget {
  const EditUserCustomerWidget({
    super.key,
    this.viajeref,
  });
  ...
  @override
  State<EditUserCustomerWidget> createState() => _EditUserCustomerWidgetState();
}

class _EditUserCustomerWidgetState extends State<EditUserCustomerWidget> {
  late EditUserCustomerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditUserCustomerModel());
    ...
    _model.emailViewController ??=
        TextEditingController(text: currentUserEmail);
    _model.emailViewFocusNode ??= FocusNode();

    _model.uidUpdateController ??= TextEditingController(text: currentUserUid);
    _model.uidUpdateFocusNode ??= FocusNode();

    _model.phoneNumberUpdateController ??=
        TextEditingController(text: currentPhoneNumber);
    _model.phoneNumberUpdateFocusNode ??= FocusNode();

    _model.addressUpdateController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.addressHome, ''));
                      ...
                      children: [
                        StreamBuilder<List<UsersRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<UsersRecord> actualizarUsersRecordList =
                                snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            final actualizarUsersRecord =
                                actualizarUsersRecordList.isNotEmpty
                                    ? actualizarUsersRecordList.first
                                    : null;
                            return Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                                  ...
                                                  decoration: InputDecoration(
                                                    labelText:
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      '4v2rf02m' /* Actualizar nombre completo */,
                                                    ),
                                                    labelStyle:
                                                        FlutterFlowTheme.of(
                                                                context)
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '6gg24hz5' /* Actualizar número de documento */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                                  ...
                                                  decoration: InputDecoration(
                                                    labelText:
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      '0giatmon' /* Actualizar número de celular */,
                                                    ),
                                                    labelStyle:
                                                        FlutterFlowTheme.of(
                                                                context)
                                              ...
                                              child: AuthUserStreamWidget(
                                                builder: (context) =>
                                                  ...
                                                  text: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'sm7680jh' /* Confirmar direccion en el mapa */,
                                                  ),
                                          ...
                                          if (!((_model
                                                      ...
                                                      ?.hasFocus ??
                                                  false) ||
                                              (_model.phoneNumberUpdateFocusNode
                                                      ?.hasFocus ??
                                                  false) ||
                                              (_model.addressUpdateFocusNode
                                                      ?.hasFocus ??
                                                  false)))
                                            Padding(
                                              padding: EdgeInsetsDirectional
